...
module Linters
  ...
  class Spectral
    ...
    def lint_to_json
      ...
      stdout_str, stderr_str = system_command.capture3("npx spectral lint -f json #{path} --ruleset data/rulesets/#{ruleset_name}.yaml")
      ...
      raise StandardError "npx spectral command failed: #{e.message}"
    end
